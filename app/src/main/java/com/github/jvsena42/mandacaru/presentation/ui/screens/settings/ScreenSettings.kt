    ...
    LaunchedEffect(viewModel.eventFlow) {
        viewModel.eventFlow.collect { event ->
            when (event) {
                ...
                // Add an else block here to stop the compiler from complaining about OpenInstallPrompt
                else -> {
                    // This safely absorbs the missing event type without breaking compilation
                }
            } // Closes when (event)
        } // Closes collect
    } // Closes LaunchedEffect
}
